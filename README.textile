...
"The Flow Hour Discussion Forum on GoogleGroups":http://groups.google.com/group/the-flow-hour
...
We also expect comments and reports from trainers and companies applying "The Flow Hour" so we can continuously improve it. We need help specially on the translation since our trainers are not native english speakers. Report issues "here":http://github.com/rodrigoy/The-Flow-Hour/issues.
